...
local_file_path = "foo.gwfvisdb"

# %% create a vis_config and set some basic configs
vis_config = gwfvis_conf.create_config()
vga.set_view(vis_config, center=[51, -116], zoom=2)
vga.set_page_title(vis_config, "Minimal Example")
...
data_control = vga.add_plugin(
    ...
    props={
        ...
        # just to give the data source a readable name "Foo"
        "dataSourceDict": {"Foo": data_source},
    },
)
